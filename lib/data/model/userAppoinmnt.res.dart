...
UserAppoinmentsListRes userAppoinmentsListResFromJson(String str) =>
    UserAppoinmentsListRes.fromJson(json.decode(str));

String userAppoinmentsListResToJson(UserAppoinmentsListRes data) =>
...
class UserAppoinmentsListRes {
  ...
  factory UserAppoinmentsListRes.fromJson(Map<String, dynamic> json) =>
      UserAppoinmentsListRes(
        status: json["status"],
...
class AvailableSlots {
  ...
  AvailableSlots({required this.mon, required this.tue});
