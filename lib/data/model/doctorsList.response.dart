...
List<DoctorsListResponse> doctorsListResponseFromJson(String str) =>
    List<DoctorsListResponse>.from(
      json.decode(str).map((x) => DoctorsListResponse.fromJson(x)),
    );

String doctorsListResponseToJson(List<DoctorsListResponse> data) =>
...
enum Approvals { APPROVED, PENDING, REJECTED }
...
enum KycStatus { NOT_VERIFIED, VERIFIED }
...
enum Language { ENGLISH, HINDI, ML123456 }
...
enum Status { ACTIVE, INACTIVE, STATUS_ACTIVE }
