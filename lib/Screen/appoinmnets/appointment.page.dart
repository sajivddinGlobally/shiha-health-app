...
import 'package:shiha_health_app/Screen/appoinmnets/controller/appoinment.controller.dart';
...
class _AppointmentPageState extends ConsumerState<AppointmentPage>
    with AppoinmentController<AppointmentPage> {
  @override
  Widget build(BuildContext context) {
    final appointsAsync = fetchInit();
    return Scaffold(
      body: Stack(
        children: [
          Image.asset(
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            SizedBox(width: 8.w),
                                            Text(
                                              DateFormat("hh:mm a").format(DateFormat("HH:mm:ss").parse(item.time)),
                                              style: GoogleFonts.poppins(
                                                fontSize: 13.sp,
                                                fontWeight: FontWeight.w500,
                                                color: Color(0xFF067594),
                                          ...
                                          Expanded(
                                            child: ElevatedButton(
                                              ...
                                              onPressed: () {
                                                Navigator.push(
          context,
          CupertinoPageRoute(builder: (context) => DoctorDetailsPage(userID: item.doctor.id.toString(), hasChange: true, bookingId: item.id.toString(),)),
        );
                                              },
                                              child: Text(
                                                "Change Appointment",
