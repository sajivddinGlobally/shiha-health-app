                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            hearbuild("Heart\nRate", "${snap.profile.heartRate}", 'bpm'),
                            hearbuild("Blood\nPressure", '${snap.profile.bloodPressure}\n', "mg/hg"),
                            hearbuild("Your\nWeight", "${snap.profile.weightKg}", "kg"),
                            hearbuild("Last\nCheckup", "2", "Week ago"),
                          ],
                        ),
                      ),
                      ...
                      SizedBox(
                        height: 185.h,
                        width: MediaQuery.of(context).size.width,
                        child: Center(child: Text("Not added yet", style: GoogleFonts.inter(color: Colors.white),),),
