...
class DonationDetailsPage extends ConsumerStatefulWidget {
  final String id;
  const DonationDetailsPage({super.key, required this.id});
...
class _DonationDetailsPageState extends ConsumerState<DonationDetailsPage> {
  @override
  Widget build(BuildContext context) {
    final donationDetailsData = ref.watch(
      getDonationDetailsRequestController(widget.id),
    );
    return Scaffold(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      "Urgent ${snap.bloodGroup} Blood Needed",
                                      style: GoogleFonts.poppins(
                                        fontSize: 12.sp,
                                        fontWeight: FontWeight.w500,
                                        color: Colors.white,
                              ...
                              Text(
                                ...
                                "${snap.hospitalName}, ${snap.location}",
                                style: GoogleFonts.poppins(
                                  fontSize: 14.sp,
                                  fontWeight: FontWeight.w500,
                              ...
                              Column(
                                children: List.generate(snap.documents.length, (
                                  index,
                                ) {
                                  final fileName = snap.documents[index];

                                  final url =
                                      "https://your-domain.com/uploads/documents/$fileName";

                                  return documentbuild(fileName, () {
                                    launchUrl(
                                      Uri.parse(url),
                              ...
                              if (snap.photos.isEmpty)
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount: snap.photos.length,
                                    itemBuilder: (context, index) {
                                      final img = snap.photos[index];
                                      return Padding(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            "http://sihahealth.globallywebsolutions.com/uploads/$img",
                                            width: 135.w,
                                            height: 150.h,
                                            fit: BoxFit.cover,
                                            errorBuilder:
  ...
  Widget documentbuild(String name, VoidCallback onDownload) {
    return Container(
